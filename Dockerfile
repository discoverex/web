...
ARG NEXT_PUBLIC_IMAGE_BUCKET_NAME
ARG NEXT_PUBLIC_MODEL_BUCKET_NAME
...
ENV NEXT_PUBLIC_IMAGE_BUCKET_NAME=$NEXT_PUBLIC_IMAGE_BUCKET_NAME
ENV NEXT_PUBLIC_MODEL_BUCKET_NAME=$NEXT_PUBLIC_MODEL_BUCKET_NAME
